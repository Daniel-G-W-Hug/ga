...
class w_Statusbar : public QWidget {
  ...
  public slots:
    ...
    void on_currentModelChanged(size_t currentModelIndex);
  ...
  private:
    ...
    size_t m_currentModel{0}; // model index (default: show first step)
    size_t m_maximumModel{0}; // maximum index of models
