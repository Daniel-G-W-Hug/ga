...
void generate_and_print_pga2dp_weight_contraction()
{
    ...
    // mv_e"); prd_tab = get_prd_tab(basis_tab, mv2dp_coeff_A_even, mv2dp_coeff_B_even);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_2dp::mv_e, filter_2dp::mv_e);
    // print_mvec(prd_mv, basis);
    // fmt::println("");
    ...
    // mv_e"); prd_tab = get_prd_tab(basis_tab, mv2dp_coeff_A_uneven,
    // mv2dp_coeff_B_uneven); prd_mv = get_mv_from_prd_tab(prd_tab, basis,
    // filter_2dp::mv_u, filter_2dp::mv_u); print_mvec(prd_mv, basis); fmt::println("");


    // fmt::println("{}:", prd_name + space_str + "weight_contraction(mv_e,mv_u) ->
    // mv_u"); prd_tab = get_prd_tab(basis_tab, mv2dp_coeff_A_even, mv2dp_coeff_B_uneven);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_2dp::mv_e, filter_2dp::mv_u);
    // print_mvec(prd_mv, basis);
    // fmt::println("");
    ...
    // vec"); prd_tab = get_prd_tab(basis_tab, mv2dp_coeff_M_even, mv2dp_coeff_svBtps);
    ...
    // vec"); prd_tab = get_prd_tab(basis_tab, mv2dp_coeff_svBtps, mv2dp_coeff_M_even);
    ...
    // mv_e"); prd_tab = get_prd_tab(basis_tab, mv2dp_coeff_svBtps, mv2dp_coeff_M_uneven);
    ...
    // mv_e"); prd_tab = get_prd_tab(basis_tab, mv2dp_coeff_A_even, mv2dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_2dp::mv_e, filter_2dp::bivec);
    // print_mvec(prd_mv, basis);
    // fmt::println("");
    ...
    // vec"); prd_tab = get_prd_tab(basis_tab, mv2dp_coeff_A_uneven, mv2dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_2dp::mv_u, filter_2dp::bivec);
    // print_mvec(prd_mv, basis);
    // fmt::println("");

    // fmt::println("{}:", prd_name + space_str + "weight_contraction(bivec,mv_u) ->
    // vec"); prd_tab = get_prd_tab(basis_tab, mv2dp_coeff_svBtps, mv2dp_coeff_B_uneven);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_2dp::bivec, filter_2dp::mv_u);
    // print_mvec(prd_mv, basis);
    // fmt::println("");
    ...
    // bivec"); prd_tab = get_prd_tab(basis_tab, mv2dp_coeff_svBtps, mv2dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_2dp::ps, filter_2dp::bivec);
    // print_mvec(prd_mv, basis);
    // fmt::println("");
    ...
    // s"); prd_tab = get_prd_tab(basis_tab, mv2dp_coeff_svBtps1, mv2dp_coeff_svBtps2);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_2dp::trivec,
    // filter_2dp::trivec); print_mvec(prd_mv, basis); fmt::println("");


    // fmt::println("{}:", prd_name + space_str + "weight_contraction(trivec,bivec) ->
    // vec"); prd_tab = get_prd_tab(basis_tab, mv2dp_coeff_svBtps, mv2dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_2dp::trivec,
    // filter_2dp::bivec); print_mvec(prd_mv, basis); fmt::println("");

    // fmt::println("{}:", prd_name + space_str + "weight_contraction(bivec,trivec) ->
    // 0"); prd_tab = get_prd_tab(basis_tab, mv2dp_coeff_svBtps, mv2dp_coeff_svBtps);
...
//     fmt::println("pga2dp sandwich product - motor * object * rev(motor):");
//     fmt::println("");
