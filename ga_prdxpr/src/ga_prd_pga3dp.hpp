...
void generate_and_print_pga3dp_rdot(); // regressive dot product
...
void generate_and_print_pga3dp_rbulk_contract();   // right bulk contraction
void generate_and_print_pga3dp_rweight_contract(); // right weight contraction
void generate_and_print_pga3dp_lbulk_contract();   // left bulk contraction
void generate_and_print_pga3dp_lweight_contract(); // left weight contraction

void generate_and_print_pga3dp_rbulk_expand();   // right bulk expansion
void generate_and_print_pga3dp_rweight_expand(); // right weight expansion
void generate_and_print_pga3dp_lbulk_expand();   // left bulk expansion
void generate_and_print_pga3dp_lweight_expand(); // left weight expansion
