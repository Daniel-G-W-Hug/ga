...
const prd_rules lcontr_pga3dp_rules = {
    {"1 << 1", "1"},         {"1 << e1", "e1"},      {"1 << e2", "e2"},
    {"1 << e3", "e3"},       {"1 << e4", "e4"},      {"1 << e41", "e41"},
    {"1 << e42", "e42"},     {"1 << e43", "e43"},    {"1 << e23", "e23"},
    {"1 << e31", "e31"},     {"1 << e12", "e12"},    {"1 << e423", "e423"},
    ...
    {"e1 << e3", "0"},       {"e1 << e4", "0"},      {"e1 << e41", "-e4"},
    {"e1 << e42", "0"},      {"e1 << e43", "0"},     {"e1 << e23", "0"},
    {"e1 << e31", "-e3"},    {"e1 << e12", "e2"},    {"e1 << e423", "0"},
    {"e1 << e431", "e43"},   {"e1 << e412", "-e42"}, {"e1 << e321", "-e23"},
    {"e1 << e1234", "e423"},

    {"e2 << 1", "0"},        {"e2 << e1", "0"},      {"e2 << e2", "1"},
    {"e2 << e3", "0"},       {"e2 << e4", "0"},      {"e2 << e41", "0"},
    {"e2 << e42", "-e4"},    {"e2 << e43", "0"},     {"e2 << e23", "e3"},
    {"e2 << e31", "0"},      {"e2 << e12", "-e1"},   {"e2 << e423", "-e43"},
    {"e2 << e431", "0"},     {"e2 << e412", "e41"},  {"e2 << e321", "-e31"},
    {"e2 << e1234", "e431"},

    {"e3 << 1", "0"},        {"e3 << e1", "0"},      {"e3 << e2", "0"},
    {"e3 << e3", "1"},       {"e3 << e4", "0"},      {"e3 << e41", "0"},
    {"e3 << e42", "0"},      {"e3 << e43", "-e4"},   {"e3 << e23", "-e2"},
    {"e3 << e31", "e1"},     {"e3 << e12", "0"},     {"e3 << e423", "e42"},
    {"e3 << e431", "-e41"},  {"e3 << e412", "0"},    {"e3 << e321", "-e12"},
    {"e3 << e1234", "e412"},

    {"e4 << 1", "0"},        {"e4 << e1", "0"},      {"e4 << e2", "0"},
    {"e4 << e3", "0"},       {"e4 << e4", "1"},      {"e4 << e41", "e1"},
    {"e4 << e42", "e2"},     {"e4 << e43", "e3"},    {"e4 << e23", "0"},
    {"e4 << e31", "0"},      {"e4 << e12", "0"},     {"e4 << e423", "e23"},
    {"e4 << e431", "e31"},   {"e4 << e412", "e12"},  {"e4 << e321", "0"},
    {"e4 << e1234", "e321"},

    {"e41 << 1", "0"},       {"e41 << e1", "0"},     {"e41 << e2", "0"},
    {"e41 << e3", "0"},      {"e41 << e4", "0"},     {"e41 << e41", "-1"},
    {"e41 << e42", "0"},     {"e41 << e43", "0"},    {"e41 << e23", "0"},
    {"e41 << e31", "0"},     {"e41 << e12", "0"},    {"e41 << e423", "0"},
    {"e41 << e431", "e3"},   {"e41 << e412", "-e2"}, {"e41 << e321", "0"},
    {"e41 << e1234", "e23"},

    {"e42 << 1", "0"},       {"e42 << e1", "0"},     {"e42 << e2", "0"},
    {"e42 << e3", "0"},      {"e42 << e4", "0"},     {"e42 << e41", "0"},
    {"e42 << e42", "-1"},    {"e42 << e43", "0"},    {"e42 << e23", "0"},
    {"e42 << e31", "0"},     {"e42 << e12", "0"},    {"e42 << e423", "-e3"},
    {"e42 << e431", "0"},    {"e42 << e412", "e1"},  {"e42 << e321", "0"},
    {"e42 << e1234", "e31"},

    {"e43 << 1", "0"},       {"e43 << e1", "0"},     {"e43 << e2", "0"},
    {"e43 << e3", "0"},      {"e43 << e4", "0"},     {"e43 << e41", "0"},
    {"e43 << e42", "0"},     {"e43 << e43", "-1"},   {"e43 << e23", "0"},
    {"e43 << e31", "0"},     {"e43 << e12", "0"},    {"e43 << e423", "e2"},
    {"e43 << e431", "-e1"},  {"e43 << e412", "0"},   {"e43 << e321", "0"},
    {"e43 << e1234", "e12"},

    {"e23 << 1", "0"},       {"e23 << e1", "0"},     {"e23 << e2", "0"},
    {"e23 << e3", "0"},      {"e23 << e4", "0"},     {"e23 << e41", "0"},
    {"e23 << e42", "0"},     {"e23 << e43", "0"},    {"e23 << e23", "-1"},
    {"e23 << e31", "0"},     {"e23 << e12", "0"},    {"e23 << e423", "-e4"},
    {"e23 << e431", "0"},    {"e23 << e412", "0"},   {"e23 << e321", "e1"},
    {"e23 << e1234", "e41"},
    ...
    {"e31 << e431", "-e4"},  {"e31 << e412", "0"},   {"e31 << e321", "e2"},
    {"e31 << e1234", "e42"},
    ...
    {"e12 << e431", "0"},    {"e12 << e412", "-e4"}, {"e12 << e321", "e3"},
    {"e12 << e1234", "e43"},

    {"e423 << 1", "0"},      {"e423 << e1", "0"},    {"e423 << e2", "0"},
    {"e423 << e3", "0"},     {"e423 << e4", "0"},    {"e423 << e41", "0"},
    {"e423 << e42", "0"},    {"e423 << e43", "0"},   {"e423 << e23", "0"},
    {"e423 << e31", "0"},    {"e423 << e12", "0"},   {"e423 << e423", "-1"},
    {"e423 << e431", "0"},   {"e423 << e412", "0"},  {"e423 << e321", "0"},
    {"e423 << e1234", "e1"},
    ...
    {"e431 << e42", "0"},    {"e431 << e43", "0"},   {"e431 << e23", "0"},
    {"e431 << e31", "0"},    {"e431 << e12", "0"},   {"e431 << e423", "0"},
    {"e431 << e431", "-1"},  {"e431 << e412", "0"},  {"e431 << e321", "0"},
    {"e431 << e1234", "e2"},
    ...
    {"e412 << e42", "0"},    {"e412 << e43", "0"},   {"e412 << e23", "0"},
    {"e412 << e31", "0"},    {"e412 << e12", "0"},   {"e412 << e423", "0"},
    {"e412 << e431", "0"},   {"e412 << e412", "-1"}, {"e412 << e321", "0"},
    {"e412 << e1234", "e3"},
...
const prd_rules rcontr_pga3dp_rules = {
    {"1 >> 1", "1"},          {"1 >> e1", "0"},         {"1 >> e2", "0"},
    ...
    {"e4 >> 1", "e4"},        {"e4 >> e1", "0"},        {"e4 >> e2", "0"},
    {"e4 >> e3", "0"},        {"e4 >> e4", "1"},        {"e4 >> e41", "0"},
    {"e4 >> e42", "0"},       {"e4 >> e43", "0"},       {"e4 >> e23", "0"},
    {"e4 >> e31", "0"},       {"e4 >> e12", "0"},       {"e4 >> e423", "0"},
    {"e4 >> e431", "0"},      {"e4 >> e412", "0"},      {"e4 >> e321", "0"},
    {"e4 >> e1234", "0"},

    {"e41 >> 1", "e41"},      {"e41 >> e1", "e4"},      {"e41 >> e2", "0"},
    {"e41 >> e3", "0"},       {"e41 >> e4", "-e1"},     {"e41 >> e41", "-1"},
    {"e41 >> e42", "0"},      {"e41 >> e43", "0"},      {"e41 >> e23", "0"},
    {"e41 >> e31", "0"},      {"e41 >> e12", "0"},      {"e41 >> e423", "0"},
    {"e41 >> e431", "0"},     {"e41 >> e412", "0"},     {"e41 >> e321", "0"},
    {"e41 >> e1234", "0"},

    {"e42 >> 1", "e42"},      {"e42 >> e1", "0"},       {"e42 >> e2", "e4"},
    {"e42 >> e3", "0"},       {"e42 >> e4", "-e2"},     {"e42 >> e41", "0"},
    {"e42 >> e42", "-1"},     {"e42 >> e43", "0"},      {"e42 >> e23", "0"},
    {"e42 >> e31", "0"},      {"e42 >> e12", "0"},      {"e42 >> e423", "0"},
    {"e42 >> e431", "0"},     {"e42 >> e412", "0"},     {"e42 >> e321", "0"},
    {"e42 >> e1234", "0"},

    {"e43 >> 1", "e43"},      {"e43 >> e1", "0"},       {"e43 >> e2", "0"},
    {"e43 >> e3", "e4"},      {"e43 >> e4", "-e3"},     {"e43 >> e41", "0"},
    {"e43 >> e42", "0"},      {"e43 >> e43", "-1"},     {"e43 >> e23", "0"},
    ...
    {"e423 >> 1", "e423"},    {"e423 >> e1", "0"},      {"e423 >> e2", "-e43"},
    {"e423 >> e3", "e42"},    {"e423 >> e4", "e23"},    {"e423 >> e41", "0"},
    {"e423 >> e42", "-e3"},   {"e423 >> e43", "e2"},    {"e423 >> e23", "-e4"},
    {"e423 >> e31", "0"},     {"e423 >> e12", "0"},     {"e423 >> e423", "-1"},
    {"e423 >> e431", "0"},    {"e423 >> e412", "0"},    {"e423 >> e321", "0"},
    {"e423 >> e1234", "0"},

    {"e431 >> 1", "e431"},    {"e431 >> e1", "e43"},    {"e431 >> e2", "0"},
    {"e431 >> e3", "-e41"},   {"e431 >> e4", "e31"},    {"e431 >> e41", "e3"},
    {"e431 >> e42", "0"},     {"e431 >> e43", "-e1"},   {"e431 >> e23", "0"},
    {"e431 >> e31", "-e4"},   {"e431 >> e12", "0"},     {"e431 >> e423", "0"},
    {"e431 >> e431", "-1"},   {"e431 >> e412", "0"},    {"e431 >> e321", "0"},
    {"e431 >> e1234", "0"},

    {"e412 >> 1", "e412"},    {"e412 >> e1", "-e42"},   {"e412 >> e2", "e41"},
    {"e412 >> e3", "0"},      {"e412 >> e4", "e12"},    {"e412 >> e41", "-e2"},
    {"e412 >> e42", "e1"},    {"e412 >> e43", "0"},     {"e412 >> e23", "0"},
    {"e412 >> e31", "0"},     {"e412 >> e12", "-e4"},   {"e412 >> e423", "0"},
    {"e412 >> e431", "0"},    {"e412 >> e412", "-1"},   {"e412 >> e321", "0"},
    {"e412 >> e1234", "0"},

    {"e321 >> 1", "e321"},    {"e321 >> e1", "-e23"},   {"e321 >> e2", "-e31"},
    {"e321 >> e3", "-e12"},   {"e321 >> e4", "0"},      {"e321 >> e41", "0"},
    {"e321 >> e42", "0"},     {"e321 >> e43", "0"},     {"e321 >> e23", "e1"},
    {"e321 >> e31", "e2"},    {"e321 >> e12", "e3"},    {"e321 >> e423", "0"},
    {"e321 >> e431", "0"},    {"e321 >> e412", "0"},    {"e321 >> e321", "-1"},
    {"e321 >> e1234", "0"},

    {"e1234 >> 1", "e1234"},  {"e1234 >> e1", "-e423"}, {"e1234 >> e2", "-e431"},
    {"e1234 >> e3", "-e412"}, {"e1234 >> e4", "-e321"}, {"e1234 >> e41", "e23"},
    {"e1234 >> e42", "e31"},  {"e1234 >> e43", "e12"},  {"e1234 >> e23", "e41"},
    {"e1234 >> e31", "e42"},  {"e1234 >> e12", "e43"},  {"e1234 >> e423", "-e1"},
    {"e1234 >> e431", "-e2"}, {"e1234 >> e412", "-e3"}, {"e1234 >> e321", "-e4"},
    {"e1234 >> e1234", "1"}};
...
void generate_and_print_pga3dp_wdg();    // wedge product
void generate_and_print_pga3dp_lcontr(); // left contraction
