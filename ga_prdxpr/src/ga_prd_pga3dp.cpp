...
void generate_and_print_pga3dp_gpr()
{
    ...
    // println("equal = {}", basis_tab == gpr_pga3dp_basis_tab);
    ...
    // println("{}:", prd_name + space_str + "mv * trivec -> mv");
    ...
    // println("{}:", prd_name + space_str + "trivec * mv -> mv");
    ...
    // println("{}:", prd_name + space_str + "mv_u * ps -> mv_u");
    ...
    // println("{}:", prd_name + space_str + "ps * mv_u -> mv_u");
    ...
    println("{}:", prd_name + space_str + "mv_e * trivec -> mv_u");
    ...
    // println("{}:", prd_name + space_str + "trivec * mv_e -> mv_u");
    ...
    // println("{}:", prd_name + space_str + "mv_u * trivec -> mv_e");
    ...
    // println("{}:", prd_name + space_str + "trivec * mv_u -> mv_e");
    ...
    // println("{}:", prd_name + space_str + "ps * trivec -> vec");
    ...
    // println("{}:", prd_name + space_str + "trivec * ps -> vec");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    ...
    println("{}:", prd_name + space_str + "trivec * trivec -> mv_e");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps1, mv3dp_coeff_svBtps2);
    ...
    println("{}:", prd_name + space_str + "trivec * bivec -> mv_u");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::bivec);
    print_mvec(prd_mv, basis);
    println("");

    println("{}:", prd_name + space_str + "bivec * trivec -> mv_u");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    ...
    println("{}:", prd_name + space_str + "trivec * vec -> mv_e");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::vec);
    print_mvec(prd_mv, basis);
    println("");

    println("{}:", prd_name + space_str + "vec * trivec -> mv_e");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    ...
    println("{}:", prd_name + space_str + "trivec * s -> trivec");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::s);
    print_mvec(prd_mv, basis);
    println("");

    println("{}:", prd_name + space_str + "s * trivec -> trivec");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
...
void generate_and_print_pga3dp_wdg()
{
    ...
    // println("{}:", prd_name + space_str + "mv_e ^ trivec -> trivec");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_M_even, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_e, filter_3dp::trivec);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "trivec ^ mv_e -> trivec");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_M_even);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::mv_e);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "mv_u ^ trivec -> ps");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_M_uneven, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_u, filter_3dp::trivec);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "trivec ^ mv_u -> ps");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_M_uneven);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::mv_u);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "ps ^ trivec -> 0");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::ps, filter_3dp::trivec);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "trivec ^ ps -> 0");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::ps);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "trivec ^ trivec -> 0");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps1, mv3dp_coeff_svBtps2);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec,
    // filter_3dp::trivec); print_mvec(prd_mv, basis); println("");


    // println("{}:", prd_name + space_str + "trivec ^ bivec -> 0");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec,
    // filter_3dp::bivec); print_mvec(prd_mv, basis); println("");

    // println("{}:", prd_name + space_str + "bivec ^ trivec -> 0");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::bivec,
    // filter_3dp::trivec); print_mvec(prd_mv, basis); println("");


    println("{}:", prd_name + space_str + "trivec ^ vec -> ps");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::vec);
    print_mvec(prd_mv, basis);
    println("");

    println("{}:", prd_name + space_str + "vec ^ trivec -> ps");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::vec, filter_3dp::trivec);
    print_mvec(prd_mv, basis);
    println("");
    ...
    println("{}:", prd_name + space_str + "bivec ^ bivec -> ps");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps1, mv3dp_coeff_svBtps2);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::bivec, filter_3dp::bivec);
    print_mvec(prd_mv, basis);
    println("");
    ...
    println("{}:", prd_name + space_str + "bivec ^ vec -> trivec");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::bivec, filter_3dp::vec);
    print_mvec(prd_mv, basis);
    println("");

    println("{}:", prd_name + space_str + "vec ^ bivec -> trivec");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::vec, filter_3dp::bivec);
    print_mvec(prd_mv, basis);
    println("");
...
void generate_and_print_pga3dp_lcontr()
{
    ...
    // println("{}:", prd_name + space_str + "trivec << mv_e -> vec");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_M_even);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::mv_e);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "trivec << mv_u -> s");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_M_uneven);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::mv_u);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "ps << ps -> s");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps1, mv3dp_coeff_svBtps2);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::ps, filter_3dp::ps);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    println("{}:", prd_name + space_str + "bivec << ps -> bivec");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::bivec, filter_3dp::ps);
    print_mvec(prd_mv, basis);
    println("");
    ...
    println("{}:", prd_name + space_str + "vec << ps -> trivec");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::vec, filter_3dp::ps);
    print_mvec(prd_mv, basis);
    println("");
    ...
    // println("{}:", prd_name + space_str + "trivec << trivec -> s");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps1, mv3dp_coeff_svBtps2);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec,
    // filter_3dp::trivec); print_mvec(prd_mv, basis); println("");
    ...
    println("{}:", prd_name + space_str + "bivec << trivec -> vec");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::bivec, filter_3dp::trivec);
    print_mvec(prd_mv, basis);
    println("");
    ...
    // println("{}:", prd_name + space_str + "trivec << vec -> 0");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::vec);
    // print_mvec(prd_mv, basis);
    // println("");

    println("{}:", prd_name + space_str + "vec << trivec -> bivec");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::vec, filter_3dp::trivec);
    print_mvec(prd_mv, basis);
    println("");
    ...
    // println("{}:", prd_name + space_str + "trivec << s -> 0");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::s);
    // print_mvec(prd_mv, basis);
    // println("");
...
void generate_and_print_pga3dp_rcontr()
{
    ...
    // println("{}:", prd_name + space_str + "mv_e >> trivec -> vec");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_M_even, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_e, filter_3dp::trivec);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "mv_u >> trivec -> s");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_M_uneven, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_u, filter_3dp::trivec);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    println("{}:", prd_name + space_str + "ps >> bivec -> bivec");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::ps, filter_3dp::bivec);
    print_mvec(prd_mv, basis);
    println("");
    ...
    println("{}:", prd_name + space_str + "ps >> vec -> trivec");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::ps, filter_3dp::vec);
    print_mvec(prd_mv, basis);
    println("");
    ...
    println("{}:", prd_name + space_str + "trivec >> bivec -> vec");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::bivec);
    print_mvec(prd_mv, basis);
    println("");
    ...
    println("{}:", prd_name + space_str + "trivec >> vec -> bivec");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::vec);
    print_mvec(prd_mv, basis);
    println("");

    // println("{}:", prd_name + space_str + "vec >> trivec -> 0");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::vec, filter_3dp::trivec);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "s >> trivec -> 0");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::s, filter_3dp::trivec);
    // print_mvec(prd_mv, basis);
    // println("");
...
void generate_and_print_pga3dp_dot()
{
    ...
    println("{}:", prd_name + space_str + "dot(ps,ps) -> s");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps1, mv3dp_coeff_svBtps2);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::ps, filter_3dp::ps);
    print_mvec(prd_mv, basis);
    println("");
    ...
    println("{}:", prd_name + space_str + "dot(trivec,trivec) -> s");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps1, mv3dp_coeff_svBtps2);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::trivec);
    print_mvec(prd_mv, basis);
    println("");
...
void generate_and_print_pga3dp_rdot()
{
    ...
    println("{}:", prd_name + space_str + "rdot(trivec,trivec) -> ps");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps1, mv3dp_coeff_svBtps2);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::trivec);
    print_mvec(prd_mv, basis);
    println("");
    ...
    println("{}:", prd_name + space_str + "rdot(s,s) -> ps");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps1, mv3dp_coeff_svBtps2);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::s, filter_3dp::s);
    print_mvec(prd_mv, basis);
    println("");
...
void generate_and_print_pga3dp_rwdg()
{
    ...
    // println("{}:", prd_name + space_str + "rwdg(mv,trivec) -> mv");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_M, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv, filter_3dp::trivec);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "rwdg(trivec,mv) -> mv");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_M);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::mv);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "rwdg(mv_e,trivec) -> mv_u");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_M_even, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_e, filter_3dp::trivec);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "rwdg(trivec,mv_e) -> mv_u");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_M_even);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::mv_e);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "rwdg(mv_u,trivec) -> mv_e");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_M_uneven, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_u, filter_3dp::trivec);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "rwdg(trivec,mv_u) -> mv_e");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_M_uneven);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::mv_u);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    println("{}:", prd_name + space_str + "rwdg(ps,trivec) -> trivec");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::ps, filter_3dp::trivec);
    print_mvec(prd_mv, basis);
    println("");

    println("{}:", prd_name + space_str + "rwdg(trivec,ps) -> trivec");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::ps);
    print_mvec(prd_mv, basis);
    println("");
    ...
    println("{}:", prd_name + space_str + "rwdg(trivec,trivec) -> bivec");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps1, mv3dp_coeff_svBtps2);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::trivec);
    print_mvec(prd_mv, basis);
    println("");
    ...
    println("{}:", prd_name + space_str + "rwdg(trivec,bivec) -> vec");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::bivec);
    print_mvec(prd_mv, basis);
    println("");

    println("{}:", prd_name + space_str + "rwdg(bivec,trivec) -> vec");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::bivec, filter_3dp::trivec);
    print_mvec(prd_mv, basis);
    println("");
    ...
    println("{}:", prd_name + space_str + "rwdg(trivec,vec) -> s");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::vec);
    print_mvec(prd_mv, basis);
    println("");

    println("{}:", prd_name + space_str + "rwdg(vec,trivec) -> s");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::vec, filter_3dp::trivec);
    print_mvec(prd_mv, basis);
    println("");
    ...
    // println("{}:", prd_name + space_str + "rwdg(trivec,s) -> 0");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::s);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "rwdg(s,trivec) -> 0");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::s, filter_3dp::trivec);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    println("{}:", prd_name + space_str + "rwdg(bivec,bivec) -> s");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps1, mv3dp_coeff_svBtps2);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::bivec, filter_3dp::bivec);
    print_mvec(prd_mv, basis);
    println("");
    ...
    // println("{}:", prd_name + space_str + "rwdg(bivec,vec) -> 0");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::bivec, filter_3dp::vec);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "rwdg(vec,bivec) -> 0");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::vec, filter_3dp::bivec);
    // print_mvec(prd_mv, basis);
    // println("");
...
void generate_and_print_pga3dp_rgpr()
{
    ...
    // println("{}:", prd_name + space_str + "rgpr(mv,trivec) -> mv");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_M, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv, filter_3dp::trivec);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "rgpr(trivec,mv) -> mv");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_M);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::mv);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    println("{}:", prd_name + space_str + "rgpr(mv_e,mv_e) -> mv_e");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_A_even, mv3dp_coeff_B_even);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_e, filter_3dp::mv_e);
    print_mvec(prd_mv, basis);
    println("");
    ...
    // println("{}:", prd_name + space_str + "rgpr(mv_u,mv_u) -> mv_e");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_A_uneven, mv3dp_coeff_B_uneven);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_u, filter_3dp::mv_u);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "rgpr(mv_e,mv_u) -> mv_u");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_A_even, mv3dp_coeff_B_uneven);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_e, filter_3dp::mv_u);
    // print_mvec(prd_mv, basis);
    // println("");

    println("{}:", prd_name + space_str + "rgpr(mv_u,mv_e) -> mv_u");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_A_uneven, mv3dp_coeff_B_even);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_u, filter_3dp::mv_e);
    print_mvec(prd_mv, basis);
    println("");
    ...
    println("{}:", prd_name + space_str + "rgpr(mv_e,trivec) -> mv_u");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_M_even, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_e, filter_3dp::trivec);
    print_mvec(prd_mv, basis);
    println("");

    // println("{}:", prd_name + space_str + "rgpr(trivec,mv_e) -> mv_u");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_M_even);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::mv_e);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    println("{}:", prd_name + space_str + "rgpr(mv_u,trivec) -> mv_e");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_M_uneven, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_u, filter_3dp::trivec);
    print_mvec(prd_mv, basis);
    println("");

    // println("{}:", prd_name + space_str + "rgpr(trivec,mv_u) -> mv_e");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_M_uneven);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::mv_u);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    println("{}:", prd_name + space_str + "rgpr(mv_e,bivec) -> mv_e");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_M_even, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_e, filter_3dp::bivec);
    print_mvec(prd_mv, basis);
    println("");

    // println("{}:", prd_name + space_str + "rgpr(bivec,mv_e) -> mv_e");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_M_even);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::bivec, filter_3dp::mv_e);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    println("{}:", prd_name + space_str + "rgpr(mv_u,bivec) -> mv_u");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_M_uneven, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_u, filter_3dp::bivec);
    print_mvec(prd_mv, basis);
    println("");

    // println("{}:", prd_name + space_str + "rgpr(bivec,mv_u) -> mv_u");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_M_uneven);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::bivec, filter_3dp::mv_u);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    println("{}:", prd_name + space_str + "rgpr(mv_e,vec) -> mv_u");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_M_even, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_e, filter_3dp::vec);
    print_mvec(prd_mv, basis);
    println("");

    // println("{}:", prd_name + space_str + "rgpr(vec,mv_e) -> mv_u");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_M_even);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::vec, filter_3dp::mv_e);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "rgpr(mv_u,vec) -> mv_e");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_M_uneven, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_u, filter_3dp::vec);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "rgpr(vec,mv_u) -> mv_e");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_M_uneven);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::vec, filter_3dp::mv_u);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "rgpr(mv_e,s) -> mv_e");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_M_even, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_e, filter_3dp::s);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "rgpr(s,mv_e) -> mv_e");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_M_even);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::s, filter_3dp::mv_e);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "rgpr(mv_u,s) -> mv_u");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_M_uneven, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_u, filter_3dp::s);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "rgpr(s,mv_u) -> mv_u");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_M_uneven);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::s, filter_3dp::mv_u);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "rgpr(ps,trivec) -> trivec");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::ps, filter_3dp::trivec);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "rgpr(trivec,ps) -> trivec");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::ps);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    println("{}:", prd_name + space_str + "rgpr(trivec,trivec) -> mv_e");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps1, mv3dp_coeff_svBtps2);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::trivec);
    print_mvec(prd_mv, basis);
    println("");
    ...
    println("{}:", prd_name + space_str + "rgpr(trivec,bivec) -> mv_u");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::bivec);
    print_mvec(prd_mv, basis);
    println("");

    // println("{}:", prd_name + space_str + "rgpr(bivec,trivec) -> mv_u");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::bivec,
    // filter_3dp::trivec); print_mvec(prd_mv, basis); println("");


    println("{}:", prd_name + space_str + "rgpr(trivec,vec) -> mv_e");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::vec);
    print_mvec(prd_mv, basis);
    println("");

    // println("{}:", prd_name + space_str + "rgpr(vec,trivec) -> mv_e");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::vec, filter_3dp::trivec);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "rgpr(trivec,s) -> vec");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::s);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "rgpr(s,trivec) -> vec");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::s, filter_3dp::trivec);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    println("{}:", prd_name + space_str + "rgpr(bivec,bivec) -> mv_e");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps1, mv3dp_coeff_svBtps2);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::bivec, filter_3dp::bivec);
    print_mvec(prd_mv, basis);
    println("");
    ...
    // println("{}:", prd_name + space_str + "rgpr(bivec,vec) -> mv_u");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::bivec, filter_3dp::vec);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "rgpr(vec,bivec) -> mv_u");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::vec, filter_3dp::bivec);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "rgpr(bivec,s) -> bivec");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::bivec, filter_3dp::s);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "rgpr(s,bivec) -> bivec");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::s, filter_3dp::bivec);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    println("{}:", prd_name + space_str + "rgpr(vec,vec) -> mv_e");
    prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps1, mv3dp_coeff_svBtps2);
    prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::vec, filter_3dp::vec);
    print_mvec(prd_mv, basis);
    println("");
    ...
    // println("{}:", prd_name + space_str + "rgpr(vec,s) -> trivec");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::vec, filter_3dp::s);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "rgpr(s,vec) -> trivec");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::s, filter_3dp::vec);
    // print_mvec(prd_mv, basis);
    // println("");
...
void generate_and_print_pga3dp_bulk_contraction()
{
    ...
    // println("rhs_dual_cmpl (bulk_dualized + rcmpl):");
    ...
    // println("{}:", prd_name + space_str + "bulk_contraction(mv,mv_u) -> mv");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_A, mv3dp_coeff_B_uneven);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv, filter_3dp::mv_u);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "bulk_contraction(mv_u,mv) -> mv");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_A_uneven, mv3dp_coeff_B);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_u, filter_3dp::mv);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "bulk_contraction(mv,trivec) -> mv");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_M, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv, filter_3dp::trivec);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "bulk_contraction(trivec,mv) -> mv");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_M);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::mv);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "bulk_contraction(mv_u,mv_u) -> mv_e");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_A_uneven, mv3dp_coeff_B_uneven);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_u, filter_3dp::mv_u);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "bulk_contraction(mv_e,mv_u) -> mv_u");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_A_even, mv3dp_coeff_B_uneven);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_e, filter_3dp::mv_u);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "bulk_contraction(mv_u,mv_e) -> mv_u");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_A_uneven, mv3dp_coeff_B_even);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_u, filter_3dp::mv_e);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "bulk_contraction(mv_u,ps) -> 0");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_A_uneven, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_u, filter_3dp::ps);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "bulk_contraction(ps,mv_u) -> mv_u");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_B_uneven);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::ps, filter_3dp::mv_u);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "bulk_contraction(mv_e,trivec) ->
    // mv_u"); prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_M_even, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_e, filter_3dp::trivec);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "bulk_contraction(trivec,mv_e) ->
    ...
    // println("{}:", prd_name + space_str + "bulk_contraction(mv_u,trivec) ->
    // mv_e"); prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_M_uneven, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_u, filter_3dp::trivec);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "bulk_contraction(trivec,mv_u) ->
    ...
    // println("{}:", prd_name + space_str + "bulk_contraction(mv_u,bivec) -> vec");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_A_uneven, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_u, filter_3dp::bivec);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "bulk_contraction(bivec,mv_u) -> vec");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_B_uneven);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::bivec, filter_3dp::mv_u);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "bulk_contraction(mv_e,vec) -> mv_u");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_A_even, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_e, filter_3dp::vec);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "bulk_contraction(vec,mv_e) -> mv_u");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_B_even);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::vec, filter_3dp::mv_e);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "bulk_contraction(mv_u,vec) -> mv_e");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_A_uneven, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_u, filter_3dp::vec);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "bulk_contraction(vec,mv_u) -> s");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_B_uneven);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::vec, filter_3dp::mv_u);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "bulk_contraction(mv_u,s) -> mv_u");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_A_uneven, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::mv_u, filter_3dp::s);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "bulk_contraction(s,mv_u) -> 0");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_B_uneven);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::s, filter_3dp::mv_u);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "bulk_contraction(ps,trivec) -> vec");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::ps, filter_3dp::trivec);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "bulk_contraction(trivec,ps) -> 0");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::ps);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "bulk_contraction(ps,vec) -> trivec");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::ps, filter_3dp::vec);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "bulk_contraction(trivec,trivec) -> s");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps1, mv3dp_coeff_svBtps2);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec,
    // filter_3dp::trivec); print_mvec(prd_mv, basis); println("");


    // println("{}:", prd_name + space_str + "bulk_contraction(trivec,bivec) -> vec");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec,
    // filter_3dp::bivec); print_mvec(prd_mv, basis); println("");

    // println("{}:", prd_name + space_str + "bulk_contraction(bivec,trivec) -> 0");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::bivec,
    // filter_3dp::trivec); print_mvec(prd_mv, basis); println("");


    // println("{}:", prd_name + space_str + "bulk_contraction(trivec,vec) -> bivec");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::vec);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "bulk_contraction(vec,trivec) -> 0");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::vec, filter_3dp::trivec);
    // print_mvec(prd_mv, basis);
    // println("");
    ...
    // println("{}:", prd_name + space_str + "bulk_contraction(trivec,s) -> trivec");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::trivec, filter_3dp::s);
    // print_mvec(prd_mv, basis);
    // println("");

    // println("{}:", prd_name + space_str + "bulk_contraction(s,trivec) -> 0");
    // prd_tab = get_prd_tab(basis_tab, mv3dp_coeff_svBtps, mv3dp_coeff_svBtps);
    // prd_mv = get_mv_from_prd_tab(prd_tab, basis, filter_3dp::s, filter_3dp::trivec);
    // print_mvec(prd_mv, basis);
    // println("");
...
void generate_and_print_pga3dp_weight_contraction()
{
    ...
    // println("rhs_mv (rcmpl + weight_dualized):");
    // print_mvec(mv3dp_coeff_svBtps, rhs_cmpl_dual);
    // println("");
    ...
    // auto rhs_dual_cmpl = apply_rules_to_mv(rhs_dual, rcmpl_pga3dp_rules);
    // println("rhs_dual_cmpl (weight_dualized + rcmpl):");
    // print_mvec(mv3dp_coeff_svBtps, rhs_dual_cmpl);
    // println("");
...
//     // first product between multivectors in basis_tab (R * B)
//     println("{}:", prd_name + space_str + "mv_e * trivec -> mv_u_tmp_t");
...
//     // second product between multivectors for the product B * rev(R)
//     println("{}:", prd_name + space_str + "mv_u_tmp_t * rev(mv_e) -> mv_u_res_t");
...
void generate_and_print_pga3dp_motor_rgpr()
{
    ...
    println("pga3dp regressive sandwich product - motor * object * rrev(motor):");
    println("");
    ...
    println("{}:", prd_name + space_str + "mv_u_tmp * rrev(mv_e) -> mv_u_res");
    ...
    println("{}:", prd_name + space_str + "mv_e_tmp * rrev(mv_e) -> mv_e_res");
    ...
    // second product between multivectors for the product B * rrev(R)
    println("{}:", prd_name + space_str + "mv_u_tmp_t * rrev(mv_e) -> mv_u_res_t");
