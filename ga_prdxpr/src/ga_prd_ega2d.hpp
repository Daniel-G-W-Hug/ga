...
void generate_and_print_ega2d_lcontract(); // left contraction
void generate_and_print_ega2d_rcontract(); // right contraction

void generate_and_print_ega2d_lexpand(); // left expansion
void generate_and_print_ega2d_rexpand(); // right expansion
