...
ProductConfig get_pga2dp_twdg1_config();   // transwedge product for k=1
...
ProductConfig get_pga2dp_l_bulk_contract_config();   // left bulk contraction
ProductConfig get_pga2dp_r_bulk_contract_config();   // right bulk contraction
ProductConfig get_pga2dp_l_weight_contract_config(); // left weight contraction
ProductConfig get_pga2dp_r_weight_contract_config(); // right weight contraction
...
//
ProductConfig get_pga2dp_l_bulk_expand_config();   // left bulk expansion
ProductConfig get_pga2dp_r_bulk_expand_config();   // right bulk expansion
ProductConfig get_pga2dp_l_weight_expand_config(); // left weight expansion
ProductConfig get_pga2dp_r_weight_expand_config(); // right weight expansion

ProductConfig get_pga2dp_rgpr_config();     // regressive geometric product
ProductConfig get_pga2dp_rgpr_alt_config(); // regressive geometric product (alt. def.)
ProductConfig get_pga2dp_rtwdg1_config();   // regressive transwedge product for k=1
