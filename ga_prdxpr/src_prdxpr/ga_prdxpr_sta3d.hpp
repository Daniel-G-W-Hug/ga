...
// order k=4: quadvector (=pseudoscalar for sta3d)
const std::vector<mvec_coeff> mvsta3d_basis_kvec = {
    {"1"},
    {"g0", "g1", "g2", "g3"},
...
// - Configuration: ga_prdxpr_sta3d_config.cpp (defines algebra parameters)
// - Generation: ga_prdxpr_sta3d.cpp (creates product rules at startup)
// - Interface: This file (declares available rules)
//
// This ensures mathematically correct, consistent rules without manual errors.
////////////////////////////////////////////////////////////////////////////////
extern const prd_rules gpr_sta3d_rules; // Geometric product: a * b
extern const prd_rules wdg_sta3d_rules; // Wedge product: a ^ b
extern const prd_rules dot_sta3d_rules; // Dot product: a · b
