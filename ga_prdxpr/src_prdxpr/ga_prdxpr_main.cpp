    ...
    try {
        ...
        // PGA2DP - All 16 products
        {
            ...
            std::vector<ProductConfig> pga2dp_configs = {
                ...
                get_pga2dp_rbulk_contract_config(),
                get_pga2dp_rweight_contract_config(),
                get_pga2dp_lbulk_contract_config(),
                get_pga2dp_lweight_contract_config(),
                get_pga2dp_rbulk_expand_config(),
                get_pga2dp_rweight_expand_config(),
                get_pga2dp_lbulk_expand_config(),
                get_pga2dp_lweight_expand_config(),
        ...
        // PGA3DP - All 16 products
        {
            ...
            std::vector<ProductConfig> pga3dp_configs = {
                ...
                get_pga3dp_rbulk_contract_config(),
                get_pga3dp_rweight_contract_config(),
                get_pga3dp_lbulk_contract_config(),
                get_pga3dp_lweight_contract_config(),
                get_pga3dp_rbulk_expand_config(),
                get_pga3dp_rweight_expand_config(),
                get_pga3dp_lbulk_expand_config(),
                get_pga3dp_lweight_expand_config(),
