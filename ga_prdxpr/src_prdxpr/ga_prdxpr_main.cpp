    ...
    try {
        ...
        // EGA2D
        {
            ...
            std::vector<ProductConfig> ega2d_configs = {
                ...
                get_ega2d_cmt_config(),         get_ega2d_wdg_config(),
                get_ega2d_dot_config(),         get_ega2d_dot_alt_config(),
                get_ega2d_rwdg_config(),        get_ega2d_rgpr_alt_config(),
        ...
        // EGA3D
        {
            ...
            std::vector<ProductConfig> ega3d_configs = {
                ...
                get_ega3d_cmt_config(),       get_ega3d_wdg_config(),
                get_ega3d_dot_config(),       get_ega3d_rwdg_config(),
                get_ega3d_rgpr_alt_config(),  get_ega3d_lcontract_config(),
