...
ProductConfig get_cga2dc_gpr_alt_config(); // geometric product (alternative def.)
ProductConfig get_cga2dc_twdg1_config();   // transwedge product for k=1
...
ProductConfig get_cga2dc_rgpr_alt_config(); // regr. geometric product (alt. def.)
ProductConfig get_cga2dc_rtwdg1_config();   // regressive transwedge product k=1
