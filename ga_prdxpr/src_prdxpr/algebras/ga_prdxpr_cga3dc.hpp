...
std::vector<mvec_coeff> const mv3dc_basis_kvec = {
    {"1"},
    {"e1", "e2", "e3", "e4", "e5"},
...
extern prd_rules_mt const gpr_cga3dc_rules_mt;

// single-term products
extern prd_rules const wdg_cga3dc_rules; // Wedge product: a ^ b
extern prd_rules const dot_cga3dc_rules; // Dot product: a · b
...
mvec_coeff const mv3dc_coeff_A = {
...
mvec_coeff const mv3dc_coeff_B = {
...
mvec_coeff const mv3dc_coeff_M = {
...
mvec_coeff const mv3dc_coeff_M1 = {
...
mvec_coeff const mv3dc_coeff_M2 = {
...
mvec_coeff const mv3dc_coeff_svBtQps1 = {
...
mvec_coeff const mv3dc_coeff_svBtQps2 = {
