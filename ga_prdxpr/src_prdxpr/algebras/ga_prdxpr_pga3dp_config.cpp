    ...
    return {.product_name = "gpr",
            ...
            .cases =
                {// mv
                 ...
                 // new block ---------------------------------------
                 //  {"mv * trivec -> mv", "M", "svBtps", "mv", "trivec"},
                 //  {"trivec * mv -> mv", "svBtps", "M", "trivec", "mv"},
                 //  {"mv * bivec -> mv", "M", "svBtps", "mv", "bivec"},
                 //  {"bivec * mv -> mv", "svBtps", "M", "bivec", "mv"},
                 //  {"mv * vec -> mv", "M", "svBtps", "mv", "vec"},
                 //  {"vec * mv -> mv", "svBtps", "M", "vec", "mv"},
                 // end new block -----------------------------------
