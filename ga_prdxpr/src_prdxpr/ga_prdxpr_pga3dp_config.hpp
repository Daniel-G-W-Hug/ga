...
ProductConfig get_pga3dp_rbulk_contract_config();   // right bulk contraction
ProductConfig get_pga3dp_rweight_contract_config(); // right weight contraction
ProductConfig get_pga3dp_lbulk_contract_config();   // left bulk contraction
ProductConfig get_pga3dp_lweight_contract_config(); // left weight contraction
ProductConfig get_pga3dp_rbulk_expand_config();     // right bulk expansion
ProductConfig get_pga3dp_rweight_expand_config();   // right weight expansion
ProductConfig get_pga3dp_lbulk_expand_config();     // left bulk expansion
ProductConfig get_pga3dp_lweight_expand_config();   // left weight expansion
