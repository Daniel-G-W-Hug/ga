...
void ArgumentParser::print_list() const
{
    ...
    fmt::println("  lcontract           - Left contraction");
    fmt::println("  rcontract           - Right contraction");
    fmt::println("  lexpand             - Left expansion");
    fmt::println("  rexpand             - Right expansion");
    ...
    fmt::println("  left_contract       - Left contraction");
    fmt::println("  right_contract      - Right contraction");
    fmt::println("  left_expand         - Left expansion");
    fmt::println("  right_expand        - Right expansion");
    fmt::println("  sandwich_gpr        - Sandwich product (geometric)");
    fmt::println("");
    fmt::println("PGA Product Types (pga2dp, pga3dp):");
    fmt::println("  left_bulk_contract    - Left bulk contraction");
    fmt::println("  right_bulk_contract   - Right bulk contraction");
    fmt::println("  left_weight_contract  - Left weight contraction");
    fmt::println("  right_weight_contract - Right weight contraction");
    fmt::println("  left_bulk_expand      - Left bulk expansion");
    fmt::println("  right_bulk_expand     - Right bulk expansion");
    fmt::println("  left_weight_expand    - Left weight expansion");
    fmt::println("  right_weight_expand   - Right weight expansion");
    fmt::println("  rgpr (alternative)    - Alternative regressive geometric product");
    fmt::println("  rtwdg1                - Regressive triple wedge (first variant)");
