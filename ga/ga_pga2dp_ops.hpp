...
inline constexpr Line2d<std::common_type_t<T, U>> expand(Point2d<T> const& p,
                                                         Line2d<U> const& l)
{
    return rweight_expansion2dp(Point2dp<std::common_type_t<T, U>>(p), l);
}
...
//
// lbulk_contract2dp(a,b) = rwdg(bulk_dual(a), b)
// lweight_contract2dp(a,b) = rwdg(weight_dual(a), b)
//
// rbulk_contract2dp(a,b) = rwdg(a, bulk_dual(b))
// rweight_contract2dp(a,b) = rwdg(a, weight_dual(b))
//
...
decltype(auto) lbulk_contract2dp(arg1&& a, arg2&& b)
{
...
template <typename arg1, typename arg2>
decltype(auto) lweight_contract2dp(arg1&& a, arg2&& b)
{
...
template <typename arg1, typename arg2>
decltype(auto) rbulk_contract2dp(arg1&& a, arg2&& b)
{
...
template <typename arg1, typename arg2>
decltype(auto) rweight_contract2dp(arg1&& a, arg2&& b)
{
...
//
// lbulk_expansion2dp(a,b) = wdg(bulk_dual(a), b)       (dual to lweight_contract)
// lweight_expansion2dp(a,b) = wdg(weight_dual(a), b)   (dual to lbulk_contract)
//
// rbulk_expansion2dp(a,b) = wdg(a, bulk_dual(b))       (dual to rweight_contract)
// rweight_expansion2dp(a,b) = wdg(a, weight_dual(b))   (dual to rbulk_contract)
//
...
template <typename arg1, typename arg2>
decltype(auto) lbulk_expansion2dp(arg1&& a, arg2&& b)
{
...
template <typename arg1, typename arg2>
decltype(auto) lweight_expansion2dp(arg1&& a, arg2&& b)
{
...
template <typename arg1, typename arg2>
decltype(auto) rbulk_expansion2dp(arg1&& a, arg2&& b)
{
...
template <typename arg1, typename arg2>
decltype(auto) rweight_expansion2dp(arg1&& a, arg2&& b)
{
...
// Projections for 2dp:
//
// ortho_proj2dp(a, b)     = rwdg(b, rweight_expansion2dp(a, b) )
// (a projected orthogonally onto b, effectively creating a new a' contained in b)
// REQUIRES: gr(a) < gr(b)
//
//
// central_proj2dp(a, b)   = rwdg(b, rbulk_expansion2dp(a, b) )
// (a projected centrally towards origin onto b, effectively creating a new a'
// contained in b)
// REQUIRES: gr(a) < gr(b)
//
// ortho_antiproj2dp(a, b) = wdg(b, rweight_contract2dp(a, b) )
...
template <typename arg1, typename arg2> decltype(auto) ortho_proj2dp(arg1&& a, arg2&& b)
{
    ...
    return rwdg(std::forward<arg2>(b),
                rweight_expansion2dp(std::forward<arg1>(a), std::forward<arg2>(b)));
}
...
template <typename arg1, typename arg2> decltype(auto) central_proj2dp(arg1&& a, arg2&& b)
{
    ...
    // project the smaller grade object onto to larger grade object
    return rwdg(std::forward<arg2>(b),
                rbulk_expansion2dp(std::forward<arg1>(a), std::forward<arg2>(b)));
}
...
decltype(auto) ortho_antiproj2dp(arg1&& a, arg2&& b)
{
    return wdg(std::forward<arg2>(b),
               rweight_contract2dp(std::forward<arg1>(a), std::forward<arg2>(b)));
}
                                                ...
                                                BiVec2dp<U> const& B2)
{
    ...
    using ctype = std::common_type_t<T, U>;
    ctype contr = rweight_contract2dp(B1, B2);
