...
//
// Companion to ga_usr_types.hpp: collects the value_t-based aliases for the mechanics
// types in ONE findable location. They live here rather than in ga_usr_types.hpp because
// they alias templates (Inertia2dp, ...) that are only defined by the mechanics ops
// headers, which are included AFTER ga_usr_types.hpp. This header must therefore be
