...
#include "type_t/ga_vec2_t.hpp"   // Vec2_t<T, Tag> template (2-component vectors)
#include "type_t/ga_vec3_t.hpp"   // Vec3_t<T, Tag> template (3-component vectors)
#include "type_t/ga_vec4_t.hpp"   // Vec4_t<T, Tag> template (4-component vectors)
