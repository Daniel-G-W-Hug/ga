...
struct MVec16_t<T, mvec4d_tag> : public MVec16_t<T, default_tag> {
    ...
    constexpr MVec16_t(Scalar4d<T> s) :
    ...
    constexpr MVec16_t(Vec4d<T> const& v) :
    ...
    constexpr MVec16_t(BiVec4d<T> const& B) :
    ...
    constexpr MVec16_t(TriVec4d<T> const& t) :
    ...
    constexpr MVec16_t(PScalar4d<T> ps) :
        MVec16_t(T(0.0), T(0.0), T(0.0), T(0.0), T(0.0), T(0.0), T(0.0), T(0.0), T(0.0),
