...
struct MVec16_t<T, mvec3dp_tag> : public MVec16_t<T, default_tag> {
    ...
    constexpr MVec16_t(Scalar3dp<T> s) :
    ...
    constexpr MVec16_t(Vec3dp<T> const& v) :
    ...
    constexpr MVec16_t(BiVec3dp<T> const& B) :
    ...
    constexpr MVec16_t(TriVec3dp<T> const& t) :
    ...
    constexpr MVec16_t(PScalar3dp<T> ps) :
        MVec16_t(T(0.0), T(0.0), T(0.0), T(0.0), T(0.0), T(0.0), T(0.0), T(0.0), T(0.0),
    ...
    constexpr MVec16_t(Scalar3dp<T> s, BiVec3dp<T> const& B, PScalar3dp<T> ps) :
    ...
    // assign components of an even grade multivector
    constexpr MVec16_t(MVec3dp_E<T> const& M) :
    ...
    constexpr MVec16_t(Vec3dp<T> const& v, TriVec3dp<T> const& t) :
        MVec16_t(T(0.0), v.x, v.y, v.z, v.w, T(0.0), T(0.0), T(0.0), T(0.0), T(0.0),
    ...
    // assign components of an odd grade multivector
    constexpr MVec16_t(MVec3dp_U<T> const& M) :
    ...
    // assign components of an even grade multivector
    constexpr MVec16_t(Scalar3dp<T> s, Vec3dp<T> const& v, BiVec3dp<T> const& B,
    ...
    MVec16_t& operator+=(MVec16_t<U, mvec3dp_tag> const& v) noexcept
    {
        this->c0 += v.c0;
        this->c1 += v.c1;
        this->c2 += v.c2;
...
template <typename T>
    requires(numeric_type<T>)
constexpr Scalar3dp<T> gr0(MVec3dp<T> const& M)
{
...
template <typename T>
    requires(numeric_type<T>)
constexpr Vec3dp<T> gr1(MVec3dp<T> const& M)
{
...
template <typename T>
    requires(numeric_type<T>)
constexpr BiVec3dp<T> gr2(MVec3dp<T> const& M)
{
...
template <typename T>
    requires(numeric_type<T>)
constexpr TriVec3dp<T> gr3(MVec3dp<T> const& M)
{
...
template <typename T>
    requires(numeric_type<T>)
constexpr PScalar3dp<T> gr4(MVec3dp<T> const& M)
{
...
constexpr MVec3dp<std::common_type_t<T, U>> operator+(Scalar3dp<T> s, Vec3dp<U> const& v)
{
    using ctype = std::common_type_t<T, U>;
    return MVec3dp<ctype>(s, v, BiVec3dp<ctype>{}, TriVec3dp<ctype>{},
                          PScalar3dp<ctype>{});
}
...
template <typename T, typename U>
    requires(numeric_type<T> && numeric_type<U>)
constexpr MVec3dp<std::common_type_t<T, U>> operator+(Vec3dp<T> const& v, Scalar3dp<U> s)
{
    using ctype = std::common_type_t<T, U>;
    return MVec3dp<ctype>(s, v, BiVec3dp<ctype>{}, TriVec3dp<ctype>{},
                          PScalar3dp<ctype>{});
...
{
    using ctype = std::common_type_t<T, U>;
    return MVec3dp<ctype>(Scalar3dp<ctype>{}, v, B, TriVec3dp<ctype>{},
                          PScalar3dp<ctype>{});
}
...
{
    using ctype = std::common_type_t<T, U>;
    return MVec3dp<ctype>(Scalar3dp<ctype>{}, v, BiVec3dp<ctype>{}, TriVec3dp<ctype>{},
                          ps);
}
...
{
    using ctype = std::common_type_t<T, U>;
    return MVec3dp<ctype>(Scalar3dp<ctype>{}, Vec3dp<ctype>{}, B, t, PScalar3dp<ctype>{});
}
...
{
    using ctype = std::common_type_t<T, U>;
    return MVec3dp<ctype>(Scalar3dp<ctype>{}, Vec3dp<ctype>{}, BiVec3dp<ctype>{}, t, ps);
}
...
{
    using ctype = std::common_type_t<T, U>;
    return MVec3dp<ctype>(Scalar3dp<ctype>{}, Vec3dp<ctype>{}, B, -t,
                          PScalar3dp<ctype>{});
}
