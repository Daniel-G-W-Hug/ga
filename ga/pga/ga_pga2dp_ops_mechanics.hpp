...
// - joint_range2dp      -> where a 1-dof joint MAY GO (an interval on q; neutral
...
class dynamic_system2dp : public kinematic_system2dp {
  ...
  public:
    ...
    void set_joint_range(size_t idx, joint_range2dp const& r) { joint[idx].range = r; }
    void set_joint_drive(size_t idx, joint_drive2dp const& d) { joint[idx].drive = d; }
