    ...
    nb::class_<joint_state3dp>(m, "joint_state3dp")
        ...
        .def(
            ...
            [](joint_state3dp* self, joint3dp const& type, bivec3dp const& screw_b,
               ...
               double damping, double q_rest, joint_range3dp const& range,
               joint_drive3dp const& drive, std::vector<bivec3dp> const& screws,
        ...
        .def_rw("range", &joint_state3dp::range)
        .def_rw("drive", &joint_state3dp::drive)
