...
{
    nb::class_<dualnum2dc>(m, "dualnum2dc")
        .def(nb::init<>())
        ...
        .def("__init__",
             [](dualnum2dc* self,
                nb::ndarray<double, nb::shape<2>, nb::c_contig, nb::device::cpu> arr) {
                 ...
                 new (self) dualnum2dc(d[0], d[1]);
             })
        .def_rw("c0", &dualnum2dc::c0)
        .def_rw("c1", &dualnum2dc::c1)
        .def("__repr__",
             [](const dualnum2dc& v) {
                 return fmt::format("dualnum2dc({}, {})", v.c0, v.c1);
             })
        .def("__str__", [](const dualnum2dc& v) { return fmt::format("{}", v); })
        .def(
            "__format__",
            [](const dualnum2dc& v, std::string_view spec) {
                try {
        ...
        .def(
            "__array__",
            [](dualnum2dc const& v, nb::handle /*dtype*/, nb::handle /*copy*/) {
