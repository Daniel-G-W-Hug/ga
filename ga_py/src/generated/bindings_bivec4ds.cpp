...
void bind_bivec4ds(nb::module_& m)
{
    nb::class_<bivec4ds>(m, "bivec4ds")
        ...
        .def(
            ...
            nb::is_operator())
        .def(
            "__add__", [](bivec4ds const& a, mvec4ds const& b) { return a + b; },
            nb::is_operator())
        .def(
            "__add__", [](bivec4ds const& a, mvec4ds_u const& b) { return a + b; },
            nb::is_operator())
        .def(
        ...
        .def(
            ...
            nb::is_operator())
        .def(
            "__sub__", [](bivec4ds const& a, mvec4ds const& b) { return a - b; },
            nb::is_operator())
        .def(
            "__sub__", [](bivec4ds const& a, mvec4ds_u const& b) { return a - b; },
            nb::is_operator())
        .def(
