...
void bind_mvec2dp_u(nb::module_& m) {
    nb::class_<mvec2dp_u>(m, "mvec2dp_u")
        ...
        .def("__xor__", [](mvec2dp_u const& a, mvec2dp const& b) { return wdg(a, b); }, nb::is_operator())
        .def("__xor__", [](mvec2dp_u const& a, mvec2dp_e const& b) { return wdg(a, b); }, nb::is_operator())
        .def("__xor__", [](mvec2dp_u const& a, pscalar2dp const& b) { return wdg(a, b); }, nb::is_operator())
        .def("__xor__", [](mvec2dp_u const& a, bivec2dp const& b) { return wdg(a, b); }, nb::is_operator())
        .def("__xor__", [](mvec2dp_u const& a, vec2dp const& b) { return wdg(a, b); }, nb::is_operator())
        .def("__xor__", [](mvec2dp_u const& a, scalar2dp const& b) { return wdg(a, b); }, nb::is_operator())
