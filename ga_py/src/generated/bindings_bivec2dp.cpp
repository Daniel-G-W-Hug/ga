...
void bind_bivec2dp(nb::module_& m) {
    nb::class_<bivec2dp>(m, "bivec2dp")
        ...
        .def_rw("y", &bivec2dp::y)
        .def_rw("z", &bivec2dp::z)
        .def("__repr__", [](const bivec2dp& v) {
            return fmt::format("bivec2dp({}, {}, {})", v.x, v.y, v.z);
        })
        .def("__str__", [](const bivec2dp& v) {
            return fmt::format("{}", v);
        })
        .def("__format__",
        ...
        .def(nb::self *= double())
        .def(nb::self /= double())
        .def("__add__", [](bivec2dp const& a, scalar2dp const& b) { return a + b; }, nb::is_operator())
        .def("__add__", [](bivec2dp const& a, mvec2dp_e const& b) { return a + b; }, nb::is_operator())
        .def("__add__", [](bivec2dp const& a, vec2dp const& b) { return a + b; }, nb::is_operator())
        .def("__add__", [](bivec2dp const& a, pscalar2dp const& b) { return a + b; }, nb::is_operator())
        .def("__add__", [](bivec2dp const& a, dualnum2dp const& b) { return a + b; }, nb::is_operator())
        .def("__sub__", [](bivec2dp const& a, scalar2dp const& b) { return a - b; }, nb::is_operator())
        .def("__sub__", [](bivec2dp const& a, mvec2dp_e const& b) { return a - b; }, nb::is_operator())
        ...
        .def("__xor__", [](bivec2dp const& a, mvec2dp const& b) { return wdg(a, b); }, nb::is_operator())
        .def("__xor__", [](bivec2dp const& a, mvec2dp_e const& b) { return wdg(a, b); }, nb::is_operator())
        .def("__xor__", [](bivec2dp const& a, mvec2dp_u const& b) { return wdg(a, b); }, nb::is_operator())
