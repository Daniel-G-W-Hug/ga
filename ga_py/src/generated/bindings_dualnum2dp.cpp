...
void bind_dualnum2dp(nb::module_& m)
{
    nb::class_<dualnum2dp>(m, "dualnum2dp")
        ...
        .def("__str__", [](const dualnum2dp& v) { return fmt::format("{}", v); })
        .def(
            "__format__",
        ...
        .def(
            "__array__",
            [](dualnum2dp const& v, nb::handle /*dtype*/, nb::handle /*copy*/) {
        ...
        .def(nb::self /= double())
        .def(
            "__add__", [](dualnum2dp const& a, scalar2dp const& b) { return a + b; },
            nb::is_operator())
        .def(
            "__add__", [](dualnum2dp const& a, pscalar2dp const& b) { return a + b; },
            nb::is_operator())
        .def(
            "__add__", [](dualnum2dp const& a, vec2dp const& b) { return a + b; },
            nb::is_operator())
        .def(
            "__add__", [](dualnum2dp const& a, bivec2dp const& b) { return a + b; },
            nb::is_operator())
        .def(
            "__add__", [](dualnum2dp const& a, mvec2dp_e const& b) { return a + b; },
            nb::is_operator())
        .def(
            "__add__", [](dualnum2dp const& a, mvec2dp_u const& b) { return a + b; },
            nb::is_operator())
        .def(
            "__add__", [](dualnum2dp const& a, mvec2dp const& b) { return a + b; },
            nb::is_operator())
        .def(
            "__sub__", [](dualnum2dp const& a, scalar2dp const& b) { return a - b; },
            nb::is_operator())
        .def(
            "__sub__", [](dualnum2dp const& a, pscalar2dp const& b) { return a - b; },
            nb::is_operator())
        .def(
            "__sub__", [](dualnum2dp const& a, vec2dp const& b) { return a - b; },
            nb::is_operator())
        .def(
            "__sub__", [](dualnum2dp const& a, bivec2dp const& b) { return a - b; },
            nb::is_operator())
        .def(
            "__sub__", [](dualnum2dp const& a, mvec2dp_e const& b) { return a - b; },
            nb::is_operator())
        .def(
            "__sub__", [](dualnum2dp const& a, mvec2dp_u const& b) { return a - b; },
            nb::is_operator())
        .def(
            "__sub__", [](dualnum2dp const& a, mvec2dp const& b) { return a - b; },
            nb::is_operator())
