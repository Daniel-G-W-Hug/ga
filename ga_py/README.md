...
at `ga_test/src/ga_appl2dp_mechanics_test.hpp:1490` line-for-line and reproduces the same
trajectory (energy drift < 1 µJ over 60 RK4 steps).

The bindings are hand-written in
[`ga_py/src/bindings_mechanics.cpp`](src/bindings_mechanics.cpp) — same pattern as
