...
local A = vec3d.new(-2, 3, 1)
local B = vec3d.new(1, 2.5, -1)
--local B = pscalar3d.new(4)
local cB = cmpl(B)
local BwcB = B ^ cB
--local BwcB = wdg(B, cB)
local Binv = inv(B)
...
print("B^cmpl(B)          = ", BwcB)
print("inv(B)             = ", Binv)
print("inv(B)*(B^cmpl(B)) = ", Binv * BwcB)
print()
-- print("A<<cmpl(B)", A << cmpl(B))
-- print("(A^B)*I_3d", (A ^ B) * I_3d)
-- print("(A^B)<<I_3d", (A ^ B) << I_3d)
-- print("(cmt(A^B,I_3d)", cmt(A ^ B, I_3d))
-- print("(A^B)^I_3d", (A ^ B) ^ I_3d)
-- print("((A^B)<<I_3d) + cmt(A^B,I_3d) + ((A^B)^I_3d)", ((A ^ B) << I_3d) + cmt(A ^ B, I_3d) + ((A ^ B) ^ I_3d))
