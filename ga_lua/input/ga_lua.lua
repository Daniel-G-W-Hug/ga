...
print("dual2d(vec2d.new(2,7))", dual2d(vec2d.new(2, 7)))
print()
print("dual2d(scalar2d.new(5))", dual2d(scalar2d.new(5)))
...
print("vc == -dual3d(bv3) --> dual definition of Hestenes, Doran, Lasenby")
print("vc ==  dual3d(bv3) --> dual definition of Macdonald")
print()
