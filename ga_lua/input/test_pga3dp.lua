...
print("bulk_nrm_sq(tv1): ", bulk_nrm_sq(tv1), "squared bulk norm")
print("bulk_nrm(tv1): ", bulk_nrm(tv1), "bulk norm")
print("weight_nrm_sq(tv1): ", weight_nrm_sq(tv1), "squared weight norm")
print("weight_nrm(tv1): ", weight_nrm(tv1), "weight norm")
print("geom_nrm_sq(tv1): ", geom_nrm_sq(tv1), "squared geometric norm")
print("geom_nrm(tv1): ", geom_nrm(tv1), "geometric norm")
...
print("gr4(dn3) =", gr4(dn3), "(pseudoscalar component)")
...
print("scalar s =", s)
print("l_bulk_dual(s) =", l_bulk_dual(s))
print("l_weight_dual(s) =", l_weight_dual(s))
print("r_bulk_dual(s) =", r_bulk_dual(s))
print("r_weight_dual(s) =", r_weight_dual(s))

print("vector v =", v)
print("l_bulk_dual(v) =", l_bulk_dual(v))
print("l_weight_dual(v) =", l_weight_dual(v))
print("r_bulk_dual(v) =", r_bulk_dual(v))
print("r_weight_dual(v) =", r_weight_dual(v))

print("bivector b =", b)
print("l_bulk_dual(b) =", l_bulk_dual(b))
print("l_weight_dual(b) =", l_weight_dual(b))
print("r_bulk_dual(b) =", r_bulk_dual(b))
print("r_weight_dual(b) =", r_weight_dual(b))

print("trivector t =", t)
print("l_bulk_dual(t) =", l_bulk_dual(t))
print("l_weight_dual(t) =", l_weight_dual(t))
print("r_bulk_dual(t) =", r_bulk_dual(t))
print("r_weight_dual(t) =", r_weight_dual(t))

print("pseudoscalar ps =", ps)
print("l_bulk_dual(ps) =", l_bulk_dual(ps))
print("l_weight_dual(ps) =", l_weight_dual(ps))
print("r_bulk_dual(ps) =", r_bulk_dual(ps))
print("r_weight_dual(ps) =", r_weight_dual(ps))

-- Test complement operations
print("\n12. Testing complement operations:")
print("---------------------------------")

print("l_cmpl(s) =", l_cmpl(s))
print("r_cmpl(s) =", r_cmpl(s))
print("l_cmpl(v) =", l_cmpl(v))
print("r_cmpl(v) =", r_cmpl(v))
print("l_cmpl(b) =", l_cmpl(b))
print("r_cmpl(b) =", r_cmpl(b))
print("l_cmpl(t) =", l_cmpl(t))
print("r_cmpl(t) =", r_cmpl(t))
print("l_cmpl(ps) =", l_cmpl(ps))
print("r_cmpl(ps) =", r_cmpl(ps))

-- Test complement identities
print("l_cmpl(r_cmpl(v)) =", l_cmpl(r_cmpl(v)))
print("r_cmpl(l_cmpl(v)) =", r_cmpl(l_cmpl(v)))
print("original v =", v)
...
print("l_cmpl(mve1) =", l_cmpl(mve1))
print("r_cmpl(mve1) =", r_cmpl(mve1))
...
print("l_cmpl(mvu1) =", l_cmpl(mvu1))
print("r_cmpl(mvu1) =", r_cmpl(mvu1))
...
print("l_cmpl(mv1) =", l_cmpl(mv1))
print("r_cmpl(mv1) =", r_cmpl(mv1))
