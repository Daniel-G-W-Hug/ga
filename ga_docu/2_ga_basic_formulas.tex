...
The four basis elements are $\{\bm{1}, \bv{1}, \bv{2}, \bv{12}\}$. Using these components
a multivector $M$ of $2d$ space is defined as
\begin{equation}
...
The ga library uses type tagging extensively for that purpose.} The eight basis elements
are $\{\bm{1}, \bv{1}, \bv{2}, \bv{3}, \bv{23}, \bv{31}, \bv{12}, \bv{123}\}$. Using these
components a multivector $M$ of $3d$ space is defined as
\begin{equation}
...
\bv{12}, \bv{321}\}$. Using these components a multivector $M$ of two-dimensional
projective space ($2dp$) is defined as
\begin{equation}
    M = s \, \bm{1} + v_1\bv{1} + v_2\bv{2} + v_3\bv{3} 
...
as pseudoscalar of this space. It is a trivector in $2dp$ Euclidean space). \\
...
there is a trivector $t$. The pseudoscalar \bv{1234} is a quadvector that
squares to $0$, because of it's component \bv{4}. Equation (\ref{eq:scalar3dp}) is the
scalar part $s_{3dp}$, equation (\ref{eq:vec3dp}) is the vector part $v_{3dp}$, equation
...
basis elements are $\{\bm{1}, \bv{1}, \bv{2}, \bv{3}, \bv{4}, \bv{41}, \bv{42}, \bv{43},
\bv{23}, \bv{31}, \bv{12}, \bv{423}, \bv{431}, \bv{412}, \bv{321}, \bv{1234}\}$.

Using these components a multivector $M$ of three-dimensional projective space ($3dp$) is
defined as
\begin{equation}
    \begin{split}
    M & = s \, \bm{1} \\
