...
that all parts depend on context, specifically on the dimensionality of the modelled
space, and thus need to be defined and treated accordingly (\emph{hint}: since \Cpp is a
