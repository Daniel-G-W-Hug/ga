...
overview on all complements in $pga3dp$ see table \ref{tab:pga3dp_complement} at the end
of this section. \\
...
For an overview on all bulk and weight duals in $pga3dp$ see table
\ref{tab:pga3dp_bulk_weight_duals} at the end of this section. The reverses can be found
in table~\ref{tab:pga3dp_rev_rrev} at the end of the section as well.\\
