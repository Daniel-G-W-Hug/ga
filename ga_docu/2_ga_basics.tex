...
\begin{subeqnarray}
    ...
    \rrev{A + B} \:\: = \:\: \rrev{A} + \rrev{B}
    \slabel{eq:rrev_linearity_def}
    \label{eq:rev_linearity_def}
\end{subeqnarray}
where $s$ is a scalar. For an overview on all bulk and weight duals in $pga3dp$ see table
\ref{tab:pga3dp_bulk_weight_duals} at the end of this section. As well the reverses can be
found in table~\ref{tab:pga3dp_rev_rrev} at the end of the section.\\
