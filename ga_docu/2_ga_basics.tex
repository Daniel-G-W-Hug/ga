...
above in equation~(\ref{eq:cmpl_def}) for any basis element. It is extended to full
...
\end{equation}
with $\metric{G}$ as the extended metric and matrix multiplication on the right hand side.
