...
The multiplicative identity of the geometric product and the wedge product is the scalar $\bm{1}$:
\begin{subeqnarray}
...
product is the pseudoscalar $\ps = I_n$ of the respective algebra:
\begin{subeqnarray}
