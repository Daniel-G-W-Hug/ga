...
\begin{itemize}
    ...
    translations (leading to objects not directly covered within the algebra).
...
\begin{itemize}
    ...
    algebra that do not contain the origin, e.g. the wedge product between two points
    defines a line.
