...
square brackets for reference)\footnote{Having the normal of the force in the $2D$
bivector instead of the force itself as in $3D$ is a consequence of the chosen basis
bivectors. When switching the sequence to \bv{31}, \bv{32}, \bv{12} in $2D$ $PGA$ the
force vector components appear in the expected sequence. This might be a more convenient
choice for $2D$ $PGA$ bivectors in a future version of the library.}
\begin{subeqnarray}
    O \wedge f & = &
    \begin{pmatrix}
        0 \\ 0 \\ 0 \\ 1 
...
\begin{subeqnarray}
    ...
    =
    \begin{pmatrix}
         X_y Y_z - X_z Y_y \\ X_z Y_x - X_x Y_z \\ X_x Y_y - X_y Y_x
    \end{pmatrix}
