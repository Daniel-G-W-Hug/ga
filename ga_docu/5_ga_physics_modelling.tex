...
\label{section_physics_modelling}
...
\begin{itemize}
    ...
    be seen from the formulas: The origin does not occur in the calculation any more due
    to the difference of the two projective points involved.
