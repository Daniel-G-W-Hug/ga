...
directly, but rather click the link to go to the linked target.}:
\begin{itemize}
    \scriptsize
    \item
    ...
    \item
    \href{https://youtu.be/NYK0GBQVngs?is=QgD4LNW-je2KvjcW}{\textit{https://www.youtube.com/@Wildberger}}
    (Norman Wildberger - Projective geometry)
    \item
    \href{https://youtu.be/2AKt6adG_OI?is=D2nWW3uoA8QRGARm}{\textit{https://www.youtube.com/@sudgylacmoe-GAoperations}}
    (sudgylacmoe, Overview of GA ops.)
    \item
...
\begin{itemize}
    ...
    (bivector home page, Leo Dorst et.al.)
    \item
    ...
    \item
    \href{https://terathon.com/blog/dual-pga.html}{\textit{https://terathon.com/blog/dual-pga.html}}
    (Lengyel's argumentation for using $R(3,0,1)$)
\end{itemize}
...
\begin{itemize}
    ...
    (Plücker coordinates in projective spaces)
        \item
    \href{https://www.youtube.com/watch?v=e7aIVSVc8cI&list=PLVuwZXwFua-2nUoECBT-y1egzZN5PA4bL&index=6}{\textit{https://www.youtube.com/@sudgylacmoe-STA}}
    (sudgylacmoe, A swift intro to spacetime algebra)
